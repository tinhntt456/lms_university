...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($course_id && $title && $due_date) {
        ...
        $stmt->bind_param('isssdi', $course_id, $title, $description, $due_date, $max_points, $instructor_id);
        if ($stmt->execute()) {
    ...
    <div class="form-container">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input type="number" id="max_points" name="max_points" min="1" max="1000" value="100">
            </div>
